...
import { index as adminCollectionsIndex } from '@/routes/admin/collections';
...
export function PortalLayout({
    ...
    return (
        ...
        >
            <aside className="fixed inset-y-0 left-0 z-30 hidden w-[272px] flex-col border-r border-slate-200 bg-white p-4 lg:flex dark:border-slate-800 dark:bg-slate-950">
                <Link
                    href={home()}
