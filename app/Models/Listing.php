...
class Listing extends Model
{
    ...
    protected function casts(): array
    {
        return [
            ...
            'sold_count_baseline' => 'integer',
            'watch_count_baseline' => 'integer',
            'view_count_baseline' => 'integer',
            'view_count' => 'integer',
        ];
    }
