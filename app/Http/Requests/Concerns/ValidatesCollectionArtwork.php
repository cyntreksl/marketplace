...
trait ValidatesCollectionArtwork
{
    /** @return array<string, array<int, mixed>> */
    protected function collectionArtworkRules(
        string $imageField,
        string $cropField,
        int $minimumWidth,
        int $minimumHeight,
    ...
    protected function prepareCollectionArtworkCrops(array $cropFields): void
    {
    ...
    protected function validateCollectionArtworkRatio(
        string $imageField,
        string $cropField,
        int $ratioWidth,
        int $ratioHeight,
