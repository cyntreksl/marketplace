...
class UpdateSeoRedirectRequest extends FormRequest
{
    ...
    {
        return $this->user()?->can('update', $this->route('seo_redirect')) ?? false;
    }
    ...
    public function rules(): array
    {
        ...
        return [
            'source_path' => ['required', 'string', 'max:255', 'regex:/^\/(?!\/)[^\s?#]*$/u', Rule::unique('seo_redirects', 'source_path')->ignore($redirect instanceof SeoRedirect ? $redirect->getKey() : null)],
